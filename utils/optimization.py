...
from .irradiance import PANEL_SPEC, calculate_yield, GRID_EMISSION_FACTOR, AVG_TARIFF_RM
...
def optimize_layout(
    ...
    panel_len_m = PANEL_SPEC["length_mm"] / 1000
    panel_wid_m = PANEL_SPEC["width_mm"] / 1000
    ...
    total_capacity_kwp = round(total_panels * PANEL_SPEC["wattage"] / 1000, 2)
    ...
    yield_data = calculate_yield(total_capacity_kwp, location, tilt_angle)
